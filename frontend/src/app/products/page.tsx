...
import ProductActions from '@/components/ProductActions'; // Criaremos este componente a seguir
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/products/novo" className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
          + Novo Produto
        </Link>
      </div>
          ...
          <tbody className="text-gray-600 text-sm font-light">
            {products.map(product => (
              <tr key={product.id} className="border-b border-gray-200 hover:bg-gray-100">
                ...
                {/* Componente para as ações de Editar e Excluir */}
